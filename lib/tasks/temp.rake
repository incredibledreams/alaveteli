    ...
    task :fix_bad_request_states => :environment do
        ...
        InfoRequest.find_each() do |info_request|
            ...
            if last_info_request_event.latest_status != info_request.described_state
                ...
                if ! dryrun
                    info_request.info_request_events.create!(:created_at => last_info_request_event.created_at + 1.second,
                                                             :last_described_at => last_info_request_event.described_at + 1.second,
